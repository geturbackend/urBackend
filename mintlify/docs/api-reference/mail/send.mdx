...
<Steps>
  <Step title="Get your Secret Key">
    Log in to the [urBackend Dashboard](https://app.urbackend.in), create a new project, and copy your **Secret Key** (`sk_live_...`) or you can get it from rotating it from project overview page.
  </Step>
...
const res = await fetch('https://api.urbackend.in/api/mail/send', {
  method: 'POST',
  headers: {
    'Content-Type': 'application/json',
...
public class Main {
  public static void main(String[] args) throws Exception {
    ...
    HttpRequest request = HttpRequest.newBuilder()
        .uri(URI.create("https://api.urbackend.in/api/mail/send"))
