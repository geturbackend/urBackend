...
description: "Delete a document from a collection by its ID. Soft deletes to the trash by default, or permanently with permanent=true."
---
...
const res = await fetch(
  `https://api.urbackend.in/api/data/posts/${docId}`,
  {
    method: 'DELETE',
    headers: {
