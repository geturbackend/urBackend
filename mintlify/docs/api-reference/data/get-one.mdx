...
const res = await fetch(
  `https://api.urbackend.in/api/data/posts/${docId}?include_deleted=true`,
  {
    headers: {
...
```bash curl
curl "https://api.urbackend.in/api/data/posts/64fd1234abcd5678ef901234?include_deleted=true" \
