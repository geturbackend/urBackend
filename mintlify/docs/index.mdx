...
<Steps>
  <Step title="Create a project">
    Sign up at the [urBackend Dashboard](https://app.urbackend.in) and create a new project. You'll receive a publishable key (`pk_live_...`) and a secret key (`sk_live_...`).
  </Step>
