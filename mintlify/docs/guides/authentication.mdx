...
<Steps>
  <Step title="Sign up a new user">
    ...
    ```javascript
    const res = await fetch('https://api.urbackend.in/api/userAuth/signup', {
      method: 'POST',
      headers: {
  ...
  <Step title="Log in">
    ...
    ```javascript
    const res = await fetch('https://api.urbackend.in/api/userAuth/login', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'x-api-key': 'pk_live_YOUR_KEY'
  ...
  <Step title="Call authenticated endpoints">
    ...
    ```javascript
    const res = await fetch('https://api.urbackend.in/api/userAuth/me', {
      headers: {
        'x-api-key': 'pk_live_YOUR_KEY',
  ...
  <Step title="Refresh the access token">
    ...
    **Web clients** — the refresh token cookie is sent automatically:
    ...
    ```javascript
    const res = await fetch('https://api.urbackend.in/api/userAuth/refresh-token', {
      method: 'POST',
  ...
  <Step title="Log out">
    ...
    ```javascript
    await fetch('https://api.urbackend.in/api/userAuth/logout', {
      method: 'POST',
      headers: { 'x-api-key': 'pk_live_YOUR_KEY' },
      credentials: 'include'
    });
...
```javascript
const res = await fetch('https://api.urbackend.in/api/userAuth/update-profile', {
  method: 'PUT',
  headers: {
    'Content-Type': 'application/json',
    'x-api-key': 'pk_live_YOUR_KEY',
...
```javascript
const res = await fetch('https://api.urbackend.in/api/userAuth/change-password', {
  method: 'PUT',
  headers: {
    'Content-Type': 'application/json',
    'x-api-key': 'pk_live_YOUR_KEY',
...
```javascript
const res = await fetch('https://api.urbackend.in/api/userAuth/public/dev_pulse', {
  headers: { 'x-api-key': 'pk_live_YOUR_KEY' }
});
```
...
<Steps>
  <Step title="Request a password reset">
    ...
    **Endpoint:** `POST /api/userAuth/request-password-reset`
    ...
    ```javascript
    const res = await fetch('https://api.urbackend.in/api/userAuth/request-password-reset', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'x-api-key': 'pk_live_YOUR_KEY'
  ...
  <Step title="Reset the password">
    ...
    **Endpoint:** `POST /api/userAuth/reset-password`
    ...
    ```javascript
    const res = await fetch('https://api.urbackend.in/api/userAuth/reset-password', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'x-api-key': 'pk_live_YOUR_KEY'
...
```javascript
const res = await fetch('https://api.urbackend.in/api/userAuth/verify-email', {
  method: 'POST',
  headers: {
    'Content-Type': 'application/json',
    'x-api-key': 'pk_live_YOUR_KEY'
