...
<Steps>
  ...
  <Step title="Copy the callback URL">
    ...
    ```
    https://api.urbackend.in/api/userAuth/social/github/callback
    ```
...
const API_URL = 'https://api.urbackend.in';
...
function AuthCallback() {
  ...
  useEffect(() => {
    async function handleCallback() {
      ...
      const response = await fetch('https://api.urbackend.in/api/userAuth/social/exchange', {
        method: 'POST',
        headers: {
