...
<Note>
  The public API now lives at `https://api.urbackend.in`. The previous host is deprecated after 30 October 2026. If your SDK version still defaults to the previous host, pass `baseUrl="https://api.urbackend.in"` to `<UrProvider>`.
</Note>
