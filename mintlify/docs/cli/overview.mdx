...
Usage is shown against your plan limits (projects, collections, database, storage, API requests, auth users, and webhooks). Limits that are unlimited on your plan display as `Unlimited`.
