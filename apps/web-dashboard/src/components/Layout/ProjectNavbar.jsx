    ...
    return (
        <div className="project-navbar">
            ...
            <nav className="nav-links">
                ...
                <NavLink to={`/project/${projectId}/mail`} className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
                    <Mail size={18} />
                    <span>Mail</span>
                </NavLink>
                ...
                <NavLink to={`/project/${projectId}/team`} className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
                    <Users size={18} />
                    <span>Team</span>
                </NavLink>
