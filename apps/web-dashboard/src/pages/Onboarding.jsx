...
// Hyperspeed animation removed for lightweight performance
    ...
    return (
        <div style={{
            ...
            <div style={{ width: '100%', maxWidth: '600px', margin: '0 auto' }}>
                ...
                <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '1.5rem', position: 'relative', zIndex: 10 }}>
                    
                    {/* Header Wizard Indicators */}
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 0.5rem' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                            <span style={{ fontSize: '1.1rem', fontWeight: 700, color: 'var(--color-text-main)', letterSpacing: '-0.02em' }}>urBackend</span>
                            <span style={{ color: 'var(--color-text-muted)', fontSize: '0.9rem' }}>/</span>
                            <span style={{ fontSize: '0.85rem', fontWeight: 500, color: 'var(--color-text-muted)' }}>onboarding</span>
                        </div>
                        
                        {/* Visual indicators for steps */}
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                            <div className={`step-dot ${isProjectStep ? 'active' : ''} ${progress.create_project ? 'completed' : ''}`} />
                            <div style={{ width: '16px', height: '1px', background: 'var(--color-border)' }} />
                    ...
                    {isProjectStep && (
                        <div className="flat-container">
                            <div style={{ marginBottom: '2rem' }}>
                                <span style={{ fontSize: '0.7rem', fontWeight: 700, color: 'var(--color-primary)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Step 1 of 3</span>
                                <h2 style={{ fontSize: '1.5rem', fontWeight: 700, marginTop: '0.5rem', letterSpacing: '-0.02em', color: 'var(--color-text-main)' }}>Create your first backend</h2>
                                <p style={{ color: 'var(--color-text-muted)', fontSize: '0.875rem', marginTop: '0.25rem', lineHeight: '1.5' }}>
                            ...
                            {progress.create_project ? (
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px', background: 'var(--color-bg-input)', border: '1px solid var(--color-border)', padding: '1rem', borderRadius: '8px' }}>
                                        <CheckCircle color="var(--color-primary)" size={20} style={{ flexShrink: 0 }} />
                                        <div>
                                            <strong style={{ color: 'var(--color-primary)', display: 'block', fontSize: '0.9rem' }}>Project successfully created</strong>
                                            <span style={{ fontSize: '0.8rem', color: 'var(--color-text-muted)' }}>You have already completed this step.</span>
                                        </div>
                                    </div>
                                    
                                    {existingProject && (
                                        <div style={{ background: 'var(--color-bg-input)', border: '1px solid var(--color-border)', borderRadius: '8px', padding: '1.25rem' }}>
                                            <div style={{ fontSize: '0.7rem', color: 'var(--color-text-muted)', textTransform: 'uppercase', fontWeight: 600 }}>Project Details</div>
                                            <h3 style={{ fontSize: '1.1rem', fontWeight: 600, marginTop: '0.5rem', color: 'var(--color-text-main)' }}>{existingProject.name}</h3>
                                            <p style={{ color: 'var(--color-text-muted)', fontSize: '0.85rem', marginTop: '0.25rem', margin: 0 }}>{existingProject.description || 'No description provided'}</p>
                                        </div>
                                    )}
                                ...
                                <form onSubmit={handleCreateProject} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                                    <div>
                                        <label style={{ display: 'block', fontSize: '0.8rem', fontWeight: 600, color: 'var(--color-text-main)', marginBottom: '0.5rem' }}>Project Name *</label>
                                        <input
                                            type="text"
                                            required
                                    ...
                                    <div>
                                        <label style={{ display: 'block', fontSize: '0.8rem', fontWeight: 600, color: 'var(--color-text-main)', marginBottom: '0.5rem' }}>Description (optional)</label>
                                        <input
                                            type="text"
                                            className="form-input"
                                    ...
                                    <div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.5rem' }}>
                                            <label style={{ display: 'block', fontSize: '0.8rem', fontWeight: 600, color: 'var(--color-text-main)' }}>MongoDB Connection URI (optional)</label>
                                            <span style={{ fontSize: '0.65rem', background: 'rgba(59, 130, 246, 0.1)', color: '#60a5fa', padding: '2px 6px', borderRadius: '4px', fontWeight: 600 }}>Pro BYOD Feature</span>
                                        </div>
                                        <input
                                            type="text"
                                            className="form-input"
                                    ...
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginTop: '0.5rem' }}>
                                        ...
                                        />
                                        <label htmlFor="includeUsers" style={{ fontSize: '0.85rem', color: 'var(--color-text-main)', cursor: 'pointer', userSelect: 'none' }}>
                    ...
                    {isCollectionStep && (
                        <div className="flat-container">
                            <div style={{ marginBottom: '2rem' }}>
                                <span style={{ fontSize: '0.7rem', fontWeight: 700, color: 'var(--color-primary)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Step 2 of 3</span>
                                <h2 style={{ fontSize: '1.5rem', fontWeight: 700, marginTop: '0.5rem', letterSpacing: '-0.02em', color: 'var(--color-text-main)' }}>Create your first collection</h2>
                                <p style={{ color: 'var(--color-text-muted)', fontSize: '0.875rem', marginTop: '0.25rem', lineHeight: '1.5' }}>
                            ...
                            {progress.create_collection && existingProject?.collections?.some(c => c.name !== 'users') ? (
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px', background: 'var(--color-bg-input)', border: '1px solid var(--color-border)', padding: '1rem', borderRadius: '8px' }}>
                                        <CheckCircle color="var(--color-primary)" size={20} style={{ flexShrink: 0 }} />
                                        <div>
                                            <strong style={{ color: 'var(--color-primary)', display: 'block', fontSize: '0.9rem' }}>Collection successfully created</strong>
                                            <span style={{ fontSize: '0.8rem', color: 'var(--color-text-muted)' }}>You have already completed this step.</span>
                                        </div>
                                    </div>
                                    ...
                                    {existingCollection && (
                                        <div style={{ background: 'var(--color-bg-input)', border: '1px solid var(--color-border)', borderRadius: '8px', padding: '1.25rem' }}>
                                            <div style={{ fontSize: '0.7rem', color: 'var(--color-text-muted)', textTransform: 'uppercase', fontWeight: 600 }}>Collection Details</div>
                                            <h3 style={{ fontSize: '1.1rem', fontWeight: 600, marginTop: '0.5rem', color: 'var(--color-text-main)' }}>{existingCollection.name}</h3>
                                            <p style={{ color: 'var(--color-text-muted)', fontSize: '0.85rem', marginTop: '0.25rem', margin: 0 }}>{existingCollection.model?.length || 0} fields defined</p>
                                        </div>
                                    )}
                                ...
                                <form onSubmit={handleCreateCollection} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                                    <div>
                                        <label style={{ display: 'block', fontSize: '0.8rem', fontWeight: 600, color: 'var(--color-text-main)', marginBottom: '0.5rem' }}>Collection Name *</label>
                                        <input
                                            type="text"
                                            required
                                            className="form-input"
                                    ...
                                    <div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.75rem' }}>
                                            <label style={{ fontSize: '0.8rem', fontWeight: 600, color: 'var(--color-text-main)' }}>Schema Fields</label>
                                            <button
                                                type="button"
                                                onClick={addField}
                                                style={{ background: 'transparent', border: '1px solid var(--color-border)', color: 'var(--color-text-main)', padding: '0.35rem 0.75rem', borderRadius: '6px', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '5px', fontSize: '0.75rem', fontWeight: 600 }}
                                            >
                                            ...
                                            {fields.map((field, idx) => (
                                                <div key={idx} style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
                                                    ...
                                                    <div style={{ display: 'flex', alignItems: 'center', gap: '5px', width: '90px' }}>
                                                        ...
                                                        />
                                                        <label htmlFor={`req-${idx}`} style={{ fontSize: '0.75rem', color: 'var(--color-text-muted)', cursor: 'pointer', userSelect: 'none' }}>Required</label>
                                                    </div>
                                                    <div style={{ display: 'flex', alignItems: 'center', gap: '5px', width: '80px' }}>
                                                        <input
                                                            ...
                                                            style={{ cursor: 'pointer', accentColor: 'var(--color-primary)' }}
                                                        />
                                                        <label htmlFor={`uniq-${idx}`} style={{ fontSize: '0.75rem', color: 'var(--color-text-muted)', cursor: 'pointer', userSelect: 'none' }}>Unique</label>
                                                    </div>
                                                    <button
                                                        type="button"
                                                        onClick={() => removeField(idx)}
                                                        disabled={fields.length <= 1}
                                                        style={{ background: 'rgba(239, 68, 68, 0.1)', color: '#f87171', border: 'none', padding: '0.65rem', borderRadius: '8px', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
                                                    >
                                                        <Trash2 size={16} />
                                                    </button>
                                                </div>
                                    ...
                                    <button
                                        ...
                                        style={{ marginTop: '0.75rem', height: '44px' }}
                                    >
                                        {collectionLoading ? <RefreshCw className="animate-spin" size={16} /> : 'Create Collection & Continue'}
                                    </button>
                                </form>
                            )}
                        </div>
                    ...
                    {isApiStep && (
                        <div className="flat-container">
                            <div style={{ marginBottom: '2rem' }}>
                                <span style={{ fontSize: '0.7rem', fontWeight: 700, color: 'var(--color-primary)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Step 3 of 3</span>
                                <h2 style={{ fontSize: '1.5rem', fontWeight: 700, marginTop: '0.5rem', letterSpacing: '-0.02em', color: 'var(--color-text-main)' }}>Your backend is ready 🚀</h2>
                                <p style={{ color: 'var(--color-text-muted)', fontSize: '0.875rem', marginTop: '0.25rem', lineHeight: '1.5' }}>
                            ...
                            {keysLoading ? (
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                                    ...
                                    {/* Keys Panel */}
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', background: 'var(--color-bg-input)', padding: '1.25rem', borderRadius: '10px', border: '1px solid var(--color-border)' }}>
                                        
                                        {/* Publishable key */}
                                        <div>
                                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.5rem' }}>
                                                <span style={{ fontSize: '0.75rem', fontWeight: 600, color: 'var(--color-text-muted)' }}>Public Key</span>
                                                <button onClick={() => copyToClipboard(publishableKey)} style={{ background: 'transparent', border: 'none', color: 'var(--color-primary)', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '4px', fontSize: '0.725rem', fontWeight: 600 }}>
                                                    <Copy size={12} /> Copy
                                                </button>
                                            </div>
                                            <div style={{ background: 'var(--color-bg-main)', padding: '0.75rem 1rem', borderRadius: '8px', border: '1px solid var(--color-border)', fontFamily: 'monospace', fontSize: '0.85rem', color: 'var(--color-primary)', overflowX: 'auto', whiteSpace: 'nowrap' }}>
                                        ...
                                        <div>
                                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.5rem' }}>
                                                <span style={{ fontSize: '0.75rem', fontWeight: 600, color: 'var(--color-text-muted)' }}>Secret Key</span>
                                                {secretKey && revealSecret && (
                                                    <button onClick={() => copyToClipboard(secretKey)} style={{ background: 'transparent', border: 'none', color: 'var(--color-primary)', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '4px', fontSize: '0.725rem', fontWeight: 600 }}>
                                                        <Copy size={12} /> Copy
                                                    </button>
                                                )}
                                            </div>
                                            <div style={{ display: 'flex', alignItems: 'center', background: 'var(--color-bg-main)', borderRadius: '8px', border: '1px solid var(--color-border)', overflow: 'hidden' }}>
                                                <div style={{ flex: 1, padding: '0.75rem 1rem', fontFamily: 'monospace', fontSize: '0.85rem', color: revealSecret ? 'var(--color-text-main)' : 'var(--color-text-muted)', overflowX: 'auto', whiteSpace: 'nowrap' }}>
                                                ...
                                                <button
                                                    ...
                                                    style={{ border: 'none', background: 'transparent', color: 'var(--color-text-muted)', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', height: '40px', width: '45px', borderLeft: '1px solid var(--color-border)' }}
                                                >
                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                                        ...
                                        <div style={{ background: 'var(--color-bg-input)', padding: '1rem', borderRadius: '8px', border: '1px solid var(--color-border)', fontFamily: 'Consolas, monospace', fontSize: '0.85rem', whiteSpace: 'pre', overflowX: 'auto', color: 'var(--color-text-main)', lineHeight: '1.5' }}>
                                    ...
                                    <div style={{ marginTop: '1rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                                        ...
                                        {testResponse && (
                                            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                                                <span style={{ fontSize: '0.75rem', fontWeight: 600, color: 'var(--color-text-muted)' }}>API Response</span>
                                                <div style={{ background: 'var(--color-bg-input)', padding: '1rem', borderRadius: '8px', border: '1px solid var(--color-border)', fontFamily: 'Consolas, monospace', fontSize: '0.85rem', overflowX: 'auto', color: testSuccess ? 'var(--color-primary)' : '#f87171' }}>
                                    ...
                                    {/* Navigation footer */}
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '1.5rem', borderTop: '1px solid var(--color-border)', paddingTop: '1.5rem' }}>
                                        {!testSuccess ? (
                                            <button
                                                type="button"
                            ...
                            {showVerifyModal && (
                                <div style={{
                                    ...
                                    <div style={{ maxWidth: '400px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.25rem' }}>
                                        <div style={{ width: '60px', height: '60px', borderRadius: '50%', background: 'rgba(62, 207, 142, 0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--color-primary)' }}>
                                            <Mail size={30} />
                                        </div>
                                        <div>
                                            <h3 style={{ fontSize: '1.25rem', fontWeight: 700, letterSpacing: '-0.02em', color: 'var(--color-text-main)' }}>Verify your email</h3>
                                            ...
                                            <form onSubmit={handleVerifyOtp} style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                                                ...
                                                <div style={{ display: 'flex', gap: '10px' }}>
                                                    <button
                                                        ...
                                                        onClick={triggerSendOtp}
                                                        style={{ flex: 1, background: 'transparent', border: '1px solid var(--color-border)', color: 'var(--color-text-main)', borderRadius: '8px', cursor: 'pointer', fontSize: '0.85rem' }}
                                                    >
                                        ...
                                        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.35rem', width: '100%' }}>
                                            <span style={{ fontSize: '0.75rem', color: 'var(--color-text-muted)' }}>Already verified?</span>
                                            <button
                                                type="button"
                                                onClick={async () => {
                                                    await refreshUser();
                                                ...
                                                style={{ background: 'transparent', border: 'none', color: 'var(--color-primary)', textDecoration: 'underline', cursor: 'pointer', fontSize: '0.825rem', fontWeight: 600 }}
                                            >
                                                Refresh Status
                                            </button>
                                        </div>
