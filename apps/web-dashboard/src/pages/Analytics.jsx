        ...
        <div className="container" style={{ maxWidth: '1200px', margin: '0 auto', paddingBottom: '4rem', padding: '0 1rem' }}>
            ...
            {!rangeStats.totalRequests ? (
                <div className="glass-card" style={{ textAlign: 'center', padding: '5rem 2rem', borderStyle: 'dashed', borderRadius: '12px', borderColor: 'var(--color-border)', maxWidth: '600px', margin: '2rem auto' }}>
                    <h2 style={{ fontSize: '1.5rem', marginBottom: '0.5rem', fontWeight: 700 }}>Analytics</h2>
                ...
                <>
                    ...
                    <div className="glass-card" style={{ borderRadius: '4px', overflow: 'hidden', marginBottom: '2rem' }}>
